...
#Random Forest com n=40, precisao = 0.7380073800738007
#conclusao:
#modelo com uma unica arvore de decisao de 3 nodos foi melhor que o modelo de Random Forest com 40 arvores
#Random Forest para n=400, precisao = 0.0.7435424354243543
#modelo com uma unica arvore de decisao de 3 nodos ainda e mais preciso